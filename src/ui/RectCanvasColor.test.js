...
describe('RectCanvasColor - Multi-Color Canvas Controller', () => {
  ...
  describe('Initialization', () => {
    test('should initialize RectCanvasColor with 2 colors', () => {
      createTestCanvas()
      const rectDraw = new RectDrawColor('test-color-canvas', 5, 5, 50, 0, 0, 2)
      const rectCanvas = new RectCanvasColor('test-color-canvas', rectDraw)
    ...
    test('should initialize with 4 colors', () => {
      createTestCanvas()
      const rectDraw = new RectDrawColor('test-color-canvas', 5, 5, 50, 0, 0, 4)
      const rectCanvas = new RectCanvasColor('test-color-canvas', rectDraw)
    ...
    test('should initialize with 256 colors', () => {
      createTestCanvas()
  ...
  describe('Color Selection', () => {
    ...
    beforeEach(() => {
      createTestCanvas()
      rectDraw = new RectDrawColor('test-color-canvas', 5, 5, 50, 0, 0, 16)
      rectCanvas = new RectCanvasColor('test-color-canvas', rectDraw)
    })
    ...
    test('should initialize selected color to 1', () => {
  ...
  describe('Color Operations', () => {
    ...
    beforeEach(() => {
      createTestCanvas()
      rectDraw = new RectDrawColor('test-color-canvas', 5, 5, 50, 0, 0, 4)
      rectCanvas = new RectCanvasColor('test-color-canvas', rectDraw)
    })
    ...
    test('should fill grid with selected color', () => {
    ...
    test('should fill with specified color', () => {
    ...
    test('should get color info for cells', () => {
    ...
    test('should handle empty grid color info', () => {
  ...
  describe('Palette Management', () => {
    ...
    test('should provide palette info', () => {
    ...
    test('should have correct palette colors', () => {
      const info = rectCanvas.getPaletteInfo()
    ...
    test('should access palette correctly', () => {
  ...
  describe('UI Integration', () => {
    ...
    test('should wire color controls without errors', () => {
      expect(() => {
    ...
    test('should handle cycle color button click', () => {
    ...
    test('should create palette swatches for small palettes', () => {
      rectCanvas.wireColorControls()
    ...
    test('should handle color input range', () => {
  ...
  describe('Color Display Updates', () => {
    ...
    test('should update display when color changes', () => {
      const display = document.getElementById('color-display')
    ...
    test('should show percentage of selected color', () => {
    ...
    test('should display hex color code', () => {
  ...
  describe('Cross-Module Integration', () => {
    test('should work with 8-bit (256 color) grid', () => {
      createTestCanvas()
      const rectDraw = new RectDrawColor(
        'test-color-canvas',
        10,
    ...
    test('should preserve RectCanvas base functionality', () => {
      createTestCanvas()
      const rectDraw = new RectDrawColor('test-color-canvas', 5, 5, 50, 0, 0, 4)
      const rectCanvas = new RectCanvasColor('test-color-canvas', rectDraw)
  ...
  describe('Error Handling', () => {
    test('should handle missing color display gracefully', () => {
      createTestCanvas()
      const rectDraw = new RectDrawColor('test-color-canvas', 5, 5, 50, 0, 0, 4)
      const rectCanvas = new RectCanvasColor('test-color-canvas', rectDraw)
    ...
    test('should handle color info without grid errors', () => {
      createTestCanvas()
      const rectDraw = new RectDrawColor('test-color-canvas', 5, 5, 50, 0, 0, 4)
      const rectCanvas = new RectCanvasColor('test-color-canvas', rectDraw)
